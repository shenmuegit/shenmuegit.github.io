...
<tr>
<td><strong>🎯 适合人群</strong></td>
<td>开发者、运维工程师、DevOps</td>
</tr>
</table>

OpenObserve + Vector 在 Kubernetes 上的日志采集实战。从架构设计到部署配置，从数据流验证到故障排查，构建完整的日志采集与分析平台。

<p align="center">
  <a href="./observability/README.md">
    <strong>📖 开始学习可观测性实战 →</strong>
  </a>
</p>
