...
> 📊 **难度**：🟢 入门 | ⏱️ **阅读时间**：20 分钟
> 
> 📝 **本章摘要**：创建 Spring Cloud 多模块项目，配置父项目依赖管理，初始化子模块结构。
...
项目初始化完成后，我们可以开始学习 Spring Cloud 的核心组件了。

---

<div align="center">

⬅️ [上一章：开发环境准备](./01-开发环境准备.md) | 🏠 [返回目录](../../../README.md) | [下一章：Eureka 服务注册中心](../03-服务注册与发现/01-Eureka-服务注册中心.md) ➡️
