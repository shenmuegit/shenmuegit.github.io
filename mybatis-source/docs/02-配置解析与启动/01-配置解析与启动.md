...
flowchart TB
    ...
    CONFIG --> |包含| P1[properties]
    CONFIG --> |包含| P2[settings]
    CONFIG --> |包含| P3[typeAliases]
    CONFIG --> |包含| P4[typeHandlers]
    CONFIG --> |包含| P5[plugins]
    CONFIG --> |包含| P6[environments]
    CONFIG --> |包含| P7[mappers]
